    ...
    <>
      ...
      <Modal title="Success" open={isModalOpen} onOk={handleOk} onCancel={handleCancel}>
        {isModalOpen ? (
           <Result
           status="success"
           title="Successfully Applied for a Record!"
           subTitle="Order number: 2017182818828182881."
           okText="View Application"
           extra={[
             <Button type="view_app" key="console" onClick={()=>navigate("/dashboard/application")}>
               View Application
             </Button>,
             <Button key="new_app" onClick={()=>navigate("/dashboard/apply")}>Create New Application</Button>,
           ]}
         />
        ) : (
          <form onSubmit={handleSubmit}>
